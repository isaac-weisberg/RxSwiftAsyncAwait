...
//    // 2
//
//    func testZip_ImmediateSchedule2() async {
...
//            
//            let v0: Observable<Int> = await Observable.just(1)
//            let v1: Observable<Int> = await Observable.just(2)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1)
...
//
//            
//            let e0: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(210)
//            ])
//            
//            let e1: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(220)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn2() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1 in
//                    Observable.zip(e0, e1).map { (a0: Int, a1: Int) -> Int in a0 + a1 }
...
//    }
//
//    func testZip_AllCompleted2() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1 in
//                    Observable.zip(e0, e1).map { (a0: Int, a1: Int) -> Int in a0 + a1 }
...
//    // 3
//
//    func testZip_ImmediateSchedule3() async {
//        let factories: [(Observable<Int>, Observable<Int>, Observable<Int>) async -> Observable<Int>] =
//            [
//                { e0, e1, e2 in
//                    await Observable.zip(e0, e1, e2).map { (a0: Int, a1: Int, a2: Int) -> Int in a0 + a1 + a2 }
//                },
//                { e0, e1, e2 in
//                    await Observable.zip(e0, e1, e2) { (a0: Int, a1: Int, a2: Int) -> Int in a0 + a1 + a2 }
//                },
//            ]
//
//        for factory in factories {
...
//            let v0: Observable<Int> = await Observable.just(1)
//            let v1: Observable<Int> = await Observable.just(2)
//            let v2: Observable<Int> = await Observable.just(3)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//    }
//
//    func testZip_Empty3() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) async -> Observable<Int>] =
//            [
//                { e0, e1, e2 in
//                    await Observable.zip(e0, e1, e2).map { (a0: Int, a1: Int, a2: Int) -> Int in a0 + a1 + a2 }
//                },
...
//            ])
//            
//            let e2: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(230)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn3() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2 in
...
//    }
//
//    func testZip_AllCompleted3() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2 in
//                    Observable.zip(e0, e1, e2).map { (a0: Int, a1: Int, a2: Int) -> Int in a0 + a1 + a2 }
...
//    // 4
//
//    func testZip_ImmediateSchedule4() async {
...
//            let v1: Observable<Int> = await Observable.just(2)
//            let v2: Observable<Int> = await Observable.just(3)
//            let v3: Observable<Int> = await Observable.just(4)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2, v3)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//            ])
//            
//            let e3: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(240)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn4() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3 in
//                    Observable.zip(e0, e1, e2, e3).map { (a0: Int, a1: Int, a2: Int, a3: Int) -> Int in a0 + a1 + a2 + a3 }
...
//    }
//
//    func testZip_AllCompleted4() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3 in
//                    Observable.zip(e0, e1, e2, e3).map { (a0: Int, a1: Int, a2: Int, a3: Int) -> Int in a0 + a1 + a2 + a3 }
...
//    // 5
//
//    func testZip_ImmediateSchedule5() async {
...
//            let v2: Observable<Int> = await Observable.just(3)
//            let v3: Observable<Int> = await Observable.just(4)
//            let v4: Observable<Int> = await Observable.just(5)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2, v3, v4)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//            ])
//            
//            let e4 = await scheduler.createHotObservable([
//                .next(150, 1)
//            ])
//            
//
...
//            ])
//            
//            let e4: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(250)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn5() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4 in
//                    Observable.zip(e0, e1, e2, e3, e4).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int) -> Int in a0 + a1 + a2 + a3 + a4 }
...
//    }
//
//    func testZip_AllCompleted5() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4 in
//                    Observable.zip(e0, e1, e2, e3, e4).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int) -> Int in a0 + a1 + a2 + a3 + a4 }
...
//    // 6
//
//    func testZip_ImmediateSchedule6() async {
...
//            let v3: Observable<Int> = await Observable.just(4)
//            let v4: Observable<Int> = await Observable.just(5)
//            let v5: Observable<Int> = await Observable.just(6)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2, v3, v4, v5)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//            ])
//            
//            let e5 = await scheduler.createHotObservable([
//                .next(150, 1)
//            ])
//            
//
...
//            ])
//            
//            let e5: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(260)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn6() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 }
...
//    }
//
//    func testZip_AllCompleted6() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 }
...
//    // 7
//
//    func testZip_ImmediateSchedule7() async {
...
//            let v4: Observable<Int> = await Observable.just(5)
//            let v5: Observable<Int> = await Observable.just(6)
//            let v6: Observable<Int> = await Observable.just(7)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2, v3, v4, v5, v6)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//            ])
//            
//            let e6 = await scheduler.createHotObservable([
//                .next(150, 1)
//            ])
//            
//
...
//            ])
//            
//            let e6: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(270)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn7() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5, e6 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5, e6).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int, a6: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 + a6 }
...
//    }
//
//    func testZip_AllCompleted7() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5, e6 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5, e6).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int, a6: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 + a6 }
...
//    // 8
//
//    func testZip_ImmediateSchedule8() async {
...
//            let v5: Observable<Int> = await Observable.just(6)
//            let v6: Observable<Int> = await Observable.just(7)
//            let v7: Observable<Int> = await Observable.just(8)
//
//            var result: Int! = nil
//
//            _ = await factory(v0, v1, v2, v3, v4, v5, v6, v7)
//                .subscribe(onNext: { (x: Int) -> Void in result = x })
//
...
//            ])
//            
//            let e7 = await scheduler.createHotObservable([
//                .next(150, 1)
//            ])
//            
//
...
//            ])
//            
//            let e7: TestableObservable<Int> = await scheduler.createHotObservable([
//                .completed(280)
//            ])
//            
//
...
//    }
//
//    func testZip_SymmetricReturn8() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5, e6, e7 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5, e6, e7).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int, a6: Int, a7: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 + a6 + a7 }
...
//    }
//
//    func testZip_AllCompleted8() async {
//        let factories: [(TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>, TestableObservable<Int>) -> Observable<Int>] =
//            [
//                { e0, e1, e2, e3, e4, e5, e6, e7 in
//                    Observable.zip(e0, e1, e2, e3, e4, e5, e6, e7).map { (a0: Int, a1: Int, a2: Int, a3: Int, a4: Int, a5: Int, a6: Int, a7: Int) -> Int in a0 + a1 + a2 + a3 + a4 + a5 + a6 + a7 }
