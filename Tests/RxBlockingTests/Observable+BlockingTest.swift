...
//    }
//    
//    func testToArray_withRealScheduler() async {
//        let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//        
//        let array = try! await Observable<Int64>.interval(.milliseconds(1), scheduler: scheduler)
//            .take(10)
//            .toBlocking()
//            .toArray()
//        
...
//    }
//
//    func testToArray_independent() async {
//        for _ in 0 ..< 10 {
//            let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//
//            func operation1() async->Observable<Int>{
//                return await Observable.of(1, 2).subscribe(on: scheduler)
//            }
//
//            let a = try! await operation1().toBlocking().toArray()
//            let b = try! await operation1().toBlocking().toArray()
//            let c = try! await operation1().toBlocking().toArray()
//            let d = try! await operation1().toBlocking().toArray()
//
...
//    }
//    
//    func testFirst_withRealScheduler() async {
//        let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//        
//        let element = try! await Observable<Int64>.interval(.milliseconds(1), scheduler: scheduler)
//            .take(10)
//            .toBlocking()
//            .first()
//        
...
//    }
//
//    func testFirst_independent() async {
//        for _ in 0 ..< 10 {
//            let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//
//            func operation1() async->Observable<Int>{
//                return await Observable.just(1).subscribe(on: scheduler)
//            }
//
//            let a = try! await operation1().toBlocking().first()
//            let b = try! await operation1().toBlocking().first()
//            let c = try! await operation1().toBlocking().first()
//            let d = try! await operation1().toBlocking().first()
//
//            XCTAssertEqual(a, 1)
//            XCTAssertEqual(b, 1)
//            XCTAssertEqual(c, 1)
...
//    }
//    
//    func testLast_withRealScheduler() async {
//        let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//        
//        let element = try! await Observable<Int64>.interval(.milliseconds(1), scheduler: scheduler)
//            .take(10)
...
//    }
//
//    func testLast_independent() async {
//        for _ in 0 ..< 10 {
...
//            }
//
//            let a = try! await operation1().toBlocking().last()
//            let b = try! await operation1().toBlocking().last()
//            let c = try! await operation1().toBlocking().last()
//            let d = try! await operation1().toBlocking().last()
//
//            XCTAssertEqual(a, 1)
//            XCTAssertEqual(b, 1)
//            XCTAssertEqual(c, 1)
...
//    }
//    
//    func testSingle_withRealScheduler() async {
//        let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//        
//        let element = try! await Observable<Int64>.interval(.milliseconds(1), scheduler: scheduler)
//            .take(1)
...
//    }
//    
//    func testSingle_predicate_someData_one_match() async {
//        var predicateVals = [Int]()
//        do {
//            let element = try await Observable.of(42, 43, 44, 45).toBlocking().single( { e in
...
//    }
//
//    func testSingle_predicate_someData_two_match() async {
//        var predicateVals = [Int]()
//        do {
//            _ = try await Observable.of(42, 43, 44, 45).toBlocking().single( { e in
//                predicateVals.append(e)
//                return e >= 43
//            } )
//            XCTFail()
...
//
//    
//    func testSingle_predicate_none() async {
//        var predicateVals = [Int]()
//        do {
//            _ = try await Observable.of(42, 43, 44, 45).toBlocking().single { e in
//                predicateVals.append(e)
...
//    }
//
//    func testSingle_predicate_throws() async {
//        var predicateVals = [Int]()
//        do {
//            _ = try await Observable.of(42, 43, 44, 45, scheduler: CurrentThreadScheduler.instance).toBlocking().single( { e in
//                predicateVals.append(e)
...
//    }
//    
//    func testSingle_predicate_withRealScheduler() async {
//        let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//        
//        let element = try! await Observable<Int64>.interval(.milliseconds(1), scheduler: scheduler)
//            .take(4)
...
//    }
//
//    func testSingle_independent() async {
//        for _ in 0 ..< 10 {
//            let scheduler = ConcurrentDispatchQueueScheduler(qos: .default)
//
//            func operation1() async->Observable<Int>{
...
//            }
//
//            let a = try! await operation1().toBlocking().single()
//            let b = try! await operation1().toBlocking().single()
//            let c = try! await operation1().toBlocking().single()
//            let d = try! await operation1().toBlocking().single()
//
//            XCTAssertEqual(a, 1)
//            XCTAssertEqual(b, 1)
//            XCTAssertEqual(c, 1)
...
//
//extension ObservableBlockingTest {
//    func testMaterialize_empty() async {
//        let result = await Observable<Int>.empty().toBlocking().materialize()
//        
//        switch result {
...
//    }
//    
//    func testMaterialize_empty_fail() async {
//        let result = await Observable<Int>.error(testError).toBlocking().materialize()
//        
//        switch result {
//        case .completed:
...
//    }
//    
//    func testMaterialize_someData() async {
//        let result = await Observable.of(42, 43, 44, 45).toBlocking().materialize()
//        
//        switch result {
//        case .completed(let elements):
...
//    }
//    
//    func testMaterialize_someData_fail() async {
//        let sequence = await Observable.concat(Observable.of(42, 43, 44, 45), Observable<Int>.error(testError))
//        let result = await sequence.toBlocking().materialize()
//        
//        switch result {
//        case .completed:
//            XCTFail("Expected result to be complete with error, but result was successful.")
