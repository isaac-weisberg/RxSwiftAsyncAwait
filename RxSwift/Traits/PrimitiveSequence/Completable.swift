...
public extension PrimitiveSequenceObservedOnMainScheduler where Trait == CompletableEvent, Element == Swift.Never {
    typealias FullCompletableObserver = @MainActor @Sendable (CompletableEvent, C) async -> Void
