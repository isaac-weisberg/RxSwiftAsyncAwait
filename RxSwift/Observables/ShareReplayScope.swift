...
private final class ShareReplay1WhileConnectedConnection<Element>:
    ...
    final func synchronized_subscribe<Observer: ObserverType>(_ observer: Observer) -> Disposable
...
private final class ShareReplay1WhileConnected<Element>:
    ...
    @inline(__always)
    private func synchronized_subscribe<Observer: ObserverType>(_ observer: Observer) -> Connection
        where Observer.Element == Element {
